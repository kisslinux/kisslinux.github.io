...
- Excludes the following software: dbus, systemd, polkit, gettext, intltool, pulseaudio, pam, startup-notification, wayland, logind, ConsoleKit2 and all Desktop Environments. See [Philosophy](#philosophy).
