...
Work has started on a [ppc64le](https://en.wikipedia.org/wiki/Ppc64) port of KISS. This is being worked on by GitHub user [jdavies-dev](https://github.com/jdavies-dev) and development can be followed [here](https://github.com/jdavies-dev/repo).
