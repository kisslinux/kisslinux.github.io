...
**RECOMMENDED**: [Create an /etc/fstab](https://wiki.archlinux.org/index.php/fstab) by UUID and additionally [pass the PARTUUID as a kernel parameter](https://wiki.archlinux.org/index.php/kernel_parameters#GRUB).
